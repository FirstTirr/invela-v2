  ...
  return (
    <PageAnimateWrapper>
      <div className="space-y-8 font-sans antialiased tracking-tight">
        <div>
          <h1 className="text-3xl font-bold text-on-surface">Rekapitulasi Kerusakan & Biaya Perbaikan</h1>
          <p className="text-base text-on-surface-variant mt-2 font-medium">Monitoring status kerusakan barang dan audit total keluaran dana operasional teknik.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white border border-surface-container-high rounded-xl p-6 flex items-center justify-between shadow-sm">
            <div className="space-y-2">
              <p className="text-xs font-bold text-outline tracking-wider uppercase">Estimasi Kebutuhan Dana Masuk</p>
              <p className="text-4xl font-extrabold text-on-surface tabular-nums">Rp 650.000</p>
              <p className="text-sm text-on-surface-variant font-medium">Total perkiraan dari barang berstatus Rusak & Perbaikan</p>
            </div>
          ...
          <div className="bg-white border border-surface-container-high rounded-xl p-6 flex items-center justify-between shadow-sm">
            <div className="space-y-2">
              <p className="text-xs font-bold text-outline tracking-wider uppercase">Total Pengeluaran Resmi (Selesai Dibayar)</p>
              <p className="text-4xl font-extrabold text-green-700 tabular-nums">Rp 150.000</p>
              <p className="text-sm font-semibold text-green-700">Akumulasi realisasi nota perbaikan bengkel sekolah</p>
            </div>
          ...
          <table className="w-full text-left border-collapse text-base">
            <thead className="bg-surface-low border-b border-surface-container-high">
              <tr>
                ...
                <th className="p-5 text-sm font-bold text-on-surface uppercase tracking-wider">Unit Kerja / Pelapor</th>
                  ...
                  <table className="w-full text-left text-base">
                    ...
                    <tbody className="divide-y divide-surface-container text-on-surface font-semibold">
                      {selectedReport.riwayatPerbaikan.length > 0 ? (
                        ...
                        <tr><td colSpan={3} className="p-6 text-center text-base text-outline font-bold">Belum ada dana yang dikeluarkan untuk barang ini.</td></tr>
                      )}
                    </tbody>
                  </table>
                </div>
