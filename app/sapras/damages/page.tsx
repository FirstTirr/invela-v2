...
export default function SaprasDamagesPage() {
  ...
  // Handlers untuk perubahan Filter & Search (Reset halaman ke 1)
      ...
      <div className="space-y-8 font-sans antialiased tracking-tight">
        <div>
          ...
          <p className="text-base text-on-surface-variant mt-2 font-medium">
            Monitoring status kerusakan barang dan audit total keluaran dana operasional teknik.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white border border-surface-container-high rounded-xl p-6 flex items-center justify-between shadow-xs">
            <div className="space-y-2">
              ...
              <p className="text-sm text-on-surface-variant font-medium">Akumulasi seluruh laporan laboratorium</p>
            </div>
          ...
          <div className="bg-white border border-surface-container-high rounded-xl p-6 flex items-center justify-between shadow-xs">
            <div className="space-y-2">
              <p className="text-xs font-bold text-outline tracking-wider uppercase">Total Realisasi Biaya Perbaikan</p>
